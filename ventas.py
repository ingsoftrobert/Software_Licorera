...
class Ventas(tk.Frame):
    ...
    def agregar_producto_pedido(self):
        ...
        try:
            ...
            self.tree_pedido.insert("", tk.END, values=(producto, cliente, cantidad, subtotal))
    ...
    def editar_cantidad(self, event):
        ...
        def guardar_cantidad():
            ...
            try:
                ...
                self.tree_pedido.item(item_id, values=(producto, cliente, nueva_cantidad, round(nuevo_subtotal, 2)))
        ...
        try:
            for item in seleccionado:
                ...
                if archivo_pdf:  # Si el usuario seleccionó una ubicación
                    ...
                    c.drawString(50, y-40, f"Subtotal: ${subtotal}")
                    c.drawString(50, y-60, f"Estado de pago: {pago}")

                    c.setFont("Helvetica-Bold", 14)
                    c.drawString(50, y-100, f"Total: ${total}")
    ...
    def cargar_datos(self):
        ...
        self.entry_factura.config(state="disabled")  # Volver a deshabilitar el campo
